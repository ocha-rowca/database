        ...
        <div class="row">
            <div class="card float-left m-1 shadow-sm mb-5 bg-white rounded" style="width: 15rem;">
                <div class="card-body">
                    ...
                    <a href="/zones" class="btn btn-primary" style="background-color:#418fde;border:none;">...</a>
                </div>
            </div>
            <div class="card float-left m-1 shadow-sm mb-5 bg-white rounded" style="width: 15rem;">
                <div class="card-body">
            ...
            <div class="card float-left m-1 shadow-sm mb-5 bg-white rounded" style="width: 15rem;">
                <div class="card-body">
                    <h5 class="card-title">Manage zones and localities</h5>
                    <p class="card-text">For restricted users</p>
                    <a href="/accessmanage" class="btn btn-primary"  style="background-color:#418fde;border:none;">Open</a>
                </div>
            </div>
        </div>
    </div>
